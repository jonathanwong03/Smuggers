...
const MapPage = () => {
  ...
  const generateMockStations = () => {
    ...
    const baseLocations = [
      ...
      { name: 'Alabama', lat: 32.3617, lng: -86.2792 },
      { name: 'Alaska', lat: 64.0685, lng: -152.2782 },
      { name: 'Arizona', lat: 34.2744, lng: -111.2847 },
      { name: 'Arkansas', lat: 34.7519, lng: -92.1313 },
      { name: 'California', lat: 36.7783, lng: -119.4179 },
      { name: 'Colorado', lat: 39.5501, lng: -105.7821 },
      { name: 'Connecticut', lat: 41.6032, lng: -73.0877 },
      { name: 'Delaware', lat: 39.1612, lng: -75.5264 },
      ...
      { name: 'Indiana', lat: 40.2732, lng: -86.1349 },
      ...
      { name: 'New York', lat: 43.2994, lng: -74.2179 },
      ...
      { name: 'Vermont', lat: 44.5588, lng: -72.5805 },
      { name: 'Virginia', lat: 37.4316, lng: -78.6569 },
      { name: 'Washington', lat: 47.7511, lng: -120.7401 },
      { name: 'West Virginia', lat: 38.3498, lng: -80.6201 },
